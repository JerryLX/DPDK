...
#	dpdk_opts="-l 1-17 -n 4 --proc-type auto --log-level 8 --socket-mem 512,512 --file-prefix pg"
	dpdk_opts="-l 1-9 -n 4 --proc-type auto --log-level 8 --socket-mem 2048,2048 --file-prefix pg"
#	dpdk_opts="${dpdk_opts} --vdev=net_tap0 --vdev=net_tap1"
	...
	pktgen_opts="${pktgen_opts} -m [2-3:4-5].0 -m [6-7:8-9].1"
...
./app/app/arm64-armv8a-linuxapp-gcc/pktgen -c 0xff -n 2 -- -P -m "[4:6].0, [5:7].1"
